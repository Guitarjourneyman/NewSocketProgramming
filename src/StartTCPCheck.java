...
public class StartTCPCheck  {
    ...
    public void startChecking() {
                ...
                int totalBits = serverTcp.array_index * 8 - serverTcp.ignored_bits; // 체크할 총 비트 수
            	...
            	for (int i = 0; i < totalBytes; i++) {
            	    ...
            	    int index = i < serverTcp.array_index ? i : serverTcp.array_index - 1; // 마지막 바이트는 인덱스를 조정
            	    // 왼쪽으로 쉬프트 후 오른쪽 비트는 1로 채움
            	    shiftedMessage[i] = (byte) ((serverTcp.checkNewMessage[index] << serverTcp.ignored_bits) |
            	        ((1 << serverTcp.ignored_bits) - 1)); // 오른쪽 비트를 모두 1로 채우기
            	}
