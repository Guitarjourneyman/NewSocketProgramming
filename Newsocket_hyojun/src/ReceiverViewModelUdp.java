                ...
                try {
                    ...
                    if (numberStr_packet != 0 ) {                      
                        ...
                        if (numberStr_packet > 0 && numberStr_packet <= TOTAL_PACKETS && !checkSerial[numberStr_packet]) {
                            ...
                            System.out.println("packet["+numberStr_packet+"] sets True");
                            ...
                            // newMessageReceived_udp 상태 업데이트 및 notifyAll() 호출
                                ...
                                System.out.println("newMessageReceived_udp sets True");
                            ...
                            if (receivedPacketCount == TOTAL_PACKETS) {
                            	...
                            	System.out.println("checkSerial resets False");
                        ...
                        else if(numberStr_packet > 0 && numberStr_packet <= TOTAL_PACKETS && checkSerial[numberStr_packet]){
                        	 // newMessageReceived_udp 상태 업데이트
                            
                                newMessageReceived_udp = false; // 이미왔던 패키지 번호였을 경우 
